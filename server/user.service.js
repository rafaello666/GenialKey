...
var _prisma_client_1 = require("@prisma.client");
...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
         ...
         */
        UsersService_1.prototype.createUser = function (username_1, plainPassword_1) {
            return __awaiter(this, arguments, void 0, function (username, plainPassword, role) {
                var existing, saltRounds, passwordHash;
                if (role === void 0) { role = _prisma_client_1.UserRole.USER; }
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.user.findUnique({ where: { username: username } })];
                        case 1:
                            existing = _a.sent();
                            if (existing) {
         ...
         */
        UsersService_1.prototype.updateUser = function (id, username, newPassword) {
            return __awaiter(this, void 0, void 0, function () {
                var user, dataToUpdate, saltRounds, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            if (!newPassword) return [3 /*break*/, 3];
                            saltRounds = 10;
                            _a = dataToUpdate;

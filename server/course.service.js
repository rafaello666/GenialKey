...
var CourseService = function () {
    ...
    var CourseService = _classThis = /** @class */ (function () {
        ...
        CourseService_1.prototype.createCourse = function (title, description) {
            return this.prisma.course.create({
                data: { title: title, description: description }
            });
        };
        CourseService_1.prototype.findAllCourses = function () {
            return this.prisma.course.findMany({
                include: { lessons: true }
            });
        };
        CourseService_1.prototype.findCourseById = function (id) {

...
let CreateUserDto = (() => {
    ...
    return _a = class CreateUserDto {
        ...
        (() => {
            ...
            _username_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.Length)(4, 20)];
            _password_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.Length)(8, 100)];

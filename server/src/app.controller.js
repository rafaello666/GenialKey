...
let AppController = (() => {
    let _classDecorators = [(0, common_1.Controller)(), (0, common_1.UseGuards)(throttler_1.ThrottlerGuard)];
    ...
    (() => {
        ...
        _getData_decorators = [(0, common_1.Get)('data')];
        ...
        __esDecorate(_classThis, null, _getData_decorators, { kind: "method", name: "getData", static: false, private: false, access: { has: obj => "getData" in obj, get: obj => obj.getData }, metadata: _metadata }, null, _instanceExtraInitializers);

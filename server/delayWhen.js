...
function delayWhen(delayDurationSelector, subscriptionDelay) {
    ...
    return (0, mergeMap_1.mergeMap)(function (value, index) { return (0, innerFrom_1.innerFrom)(delayDurationSelector(value, index)).pipe((0, take_1.take)(1), (0, mapTo_1.mapTo)(value)); });
}

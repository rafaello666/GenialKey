...
'./dto/update-<%= singular(name) %>.dto';
 ...
 %  >
    (function () {
        var _classDecorators = [(0, module_1.WebSocketGateway)()];
        var _classDescriptor;
        var _classExtraInitializers = [];
        var _classThis;
        var class_1 = _classThis = /** @class */ (function () {
            function class_1() {
            }
            return class_1;
        }());
    ...
    })()(name) %  > Gateway;
{
    ...
    if (crud) {
         %  >
        ;
        create(, create < , singular(classify(name)) %  > Dto, module_3.Create < , singular(classify(name)) %  > Dto);
        {
            return this. < ;
        ...
        update(, update < , singular(classify(name)) %  > Dto, module_2.Update < , singular(classify(name)) %  > Dto);
        {
            return this. < ;
